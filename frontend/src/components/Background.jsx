...
const AnimatedBackground = () => {
    ...
    return (
        <div className="fixed inset-0 ">
            ...
            {/* Modified diagonal grid */}
            <div className="absolute inset-0 bg-[repeating-linear-gradient(45deg,#4f4f4f10_0px,#4f4f4f10_1px,transparent_1px,transparent_24px),repeating-linear-gradient(-45deg,#4f4f4f10_0px,#4f4f4f10_1px,transparent_1px,transparent_24px)]"></div>
        </div>
    )
}
