...
const WelcomeScreen = ({ onLoadingComplete }) => {
  ...
  useEffect(() => {
    ...
    // SVG Path Animation with quicker completion
    ...
    pathEls.forEach((pathEl) => {
      ...
      const animation = anime({
        ...
        duration: anime.random(500, 1500), // Reduced from 1000-3000ms to 500-1500ms
        delay: anime.random(0, 1000), // Reduced from 0-2000ms to 0-1000ms
        loop: true,
        direction: "alternate",
    ...
    <AnimatePresence>
      {isLoading && (
        ...
        >
          ...
          {/* Animated SVG Background with Fewer, Thinner, and Lighter Lines */}
          <div
            ref={animRef}
            className="anim absolute inset-0 w-full h-full -z-10"
          >
            <svg
            ...
            >
              <g fill="none" fillRule="evenodd">
                <path
                  stroke={yourColors[0]}
                  strokeWidth="0.3" // Even thinner lines
