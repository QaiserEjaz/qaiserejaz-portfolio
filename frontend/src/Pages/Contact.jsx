...
//       // If the primary email fails, send to the secondary email
//       if (!response.ok) {
//         // console.log("Primary email failed. Trying secondary email...");
...
//         }
//       }
//       // Show success message and redirect to ThankYouPage
//       Swal.fire({
//         title: 'Success!',
...
//         id="Contact"
//       >
//         <div className="container px-[1%] sm:px-[2%] md:px-[5%] grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-[49%_49%] 2xl:grid-cols-[39%_59%] xl:grid-cols-[39%_59%] gap-10">
//           <div
//             data-aos="fade-right"
